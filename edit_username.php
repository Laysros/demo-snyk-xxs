...
<html lang="en">
  ...
  <body class="mdl-demo">
    ...
    <div class="tab-bar  color-primary--dark">
      <a href="/profile.php" class="layout__tab">Profile</a>
      <a href="/edit_username.php" class="layout__tab is-active">Update Username</a>
              ...
              <div class="col">
                <div class="card">
                  <div class="card-content">
                    <h4 class="card-title">Update your username:</h4>
                    <form class="col s12 m12" method="POST" action="/edit_username.php" id="editusernameform">
    <div class="row">
      <div class="input-field col s12 m12">
        <i class="mdi-action-account-circle prefix"></i>
        <input id="icon_prefix" type="text" class="validate" name="new_username">
        <label for="icon_prefix">New Username:</label>
      </div>
    
        
    </div>
  </form>
  <button class="btn waves-effect waves-light center" type="submit" name="Submit" value="Submit" form="editusernameform">Submit
    <i class="fa fa-sign-in right"></i>
        ...
        ?>
                    <div class="alert card red white-text">
                        <div class="card-content">
                            <p><i class="material-icons">report</i><span>Warning:</span> <?php echo $msg; ?></p>
                        </div>
                    </div>
        <?php 
            }
